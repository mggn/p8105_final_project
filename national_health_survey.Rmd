...
can make this interactive, then add different levels with other variables
The entire page can be the background information/demographics of the respondents
```{r}
flu_adult_df %>% 
